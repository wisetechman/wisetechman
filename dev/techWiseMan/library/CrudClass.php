...
class crud
{
    ...
    public function __isset($name)
    {
        ...
        /***
         *
         * @select record(s) into values from table via PK
         *
         * @access public
         *
        ...
        /**
         *
         * @execute a raw query and return result
         *
         * @access public
         *
         * @param string $sql
         ...
         * @run a raw sql query
         *
         * @param string The query to run, no return
         *
         */
        ...
        /**
         *
         * @Insert a record via the array values into a table
         *
         * @acces public
         *
         * @param string $table
        ...
        /**
         *
         * @Update a value of one field of a table using PK
         *
         * @access public
         *
         * @param string $table
        ...
        public function dbUpdateActivation( $activation){

        $this->conn();
        $sql = "UPDATE membersStatus  SET  activation  = NULL where activation = '". $activation ."';";
        $stmt = $this->db->prepare($sql);
        $stmt->bindParam(':id', $id, PDO::PARAM_STR);
        $stmt->execute();
        }
